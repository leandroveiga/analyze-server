...
@Component(value = "stepNodeDecider")
public class StepNodeDecider implements JobExecutionDecider {
    private static final Logger logger = LoggerFactory.getLogger(StepNodeDecider.class);
